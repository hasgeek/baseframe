...
from baseframe import _localized_country_list_inner, date_filter, localized_country_list
...
def cool_test():
    return date_filter(date(2020, 1, 1), format="medium")
...
class TestUtils(TestCaseBaseframe):
    ...
    def test_localized_date(self):
        with app.test_client() as c:
            rv = c.get('/localedatetest', headers={'Accept-Language': 'hi;q=0.5'})
            assert rv.data.decode('utf-8') == u"1 जन॰ 2020"
