...
!(function (a, b, c, d) {
  ...
  function A(a, b) {
    ...
    (b.overallVelocityX = j.x),
      ...
      (b.overallVelocity = mb(j.x) > mb(j.y) ? j.x : j.y),
  ...
  function Q(a, b) {
    ...
    for (e = 0; e < g.length; )
      d[g[e].identifier] && h.push(g[e]),
        b & (Cb | Db) && delete d[g[e].identifier],
        e++;
  ...
  function U(a) {
    (this.options = hb({}, this.defaults, a || {})),
      (this.id = v()),
      (this.manager = null),
  ...
  function db(a, b) {
    return (
      (b = b || {}),
      (b.recognizers = l(b.recognizers, db.defaults.preset)),
      new eb(a, b)
    );
  }
  function eb(a, b) {
    (this.options = hb({}, db.defaults, b || {})),
  ...
  i(L, x, {
    handler: function (a) {
      var b = Ob[a.type];
      b & Ab && 0 === a.button && (this.pressed = !0),
        b & Bb && 1 !== a.which && (b = Cb),
        this.pressed &&
          this.allow &&
          (b & Cb && (this.pressed = !1),
  ...
  a.MSPointerEvent &&
    !a.PointerEvent &&
    ((Tb = 'MSPointerDown'),
    (Ub = 'MSPointerMove MSPointerUp MSPointerCancel')),
    i(M, x, {
      handler: function (a) {
        var b = this.store,
          c = !1,
  ...
  i(N, x, {
    handler: function (a) {
      ...
      if ((b === Ab && (this.started = !0), this.started)) {
        ...
        b & (Cb | Db) && c[0].length - c[1].length === 0 && (this.started = !1),
          this.callback(this.manager, b, {
            pointers: c[0],
            changedPointers: c[1],
            pointerType: vb,
    ...
    set: function (a) {
      a == ac && (a = this.compute()),
        _b &&
          ...
          (this.manager.element.style[$b] = a),
  ...
  (U.prototype = {
    ...
    dropRecognizeWith: function (a) {
      return f(a, 'dropRecognizeWith', this)
        ? this
        : ((a = X(a, this)), delete this.simultaneous[a.id], this);
    },
    ...
    emit: function (a) {
      ...
      var c = this,
        d = this.state;
      jc > d && b(c.options.event + V(d)),
        b(c.options.event),
        a.additionalEvent && b(a.additionalEvent),
        d >= jc && b(c.options.event + V(d));
    },
    tryEmit: function (a) {
    ...
    recognize: function (a) {
      ...
      return k(this.options.enable, [this, b])
        ? (this.state & (kc | lc | mc) && (this.state = gc),
          (this.state = this.process(b)),
          void (this.state & (hc | ic | jc | lc) && this.tryEmit(b)))
        : (this.reset(), void (this.state = mc));
    },
    process: function () {},
    ...
    i(Z, Y, {
      defaults: { event: 'pan', threshold: 10, pointers: 1, direction: Lb },
      getTouchAction: function () {
      ...
      attrTest: function (a) {
        return (
          Y.prototype.attrTest.call(this, a) &&
          (this.state & hc || (!(this.state & hc) && this.directionTest(a)))
        );
      },
      emit: function (a) {
    ...
    i($, Y, {
      ...
      attrTest: function (a) {
        return (
          ...
          (Math.abs(a.scale - 1) > this.options.threshold || this.state & hc)
        );
      },
      emit: function (a) {
        if (1 !== a.scale) {
    ...
    i(ab, Y, {
      ...
      attrTest: function (a) {
        return (
          this._super.attrTest.call(this, a) &&
          (Math.abs(a.rotation) > this.options.threshold || this.state & hc)
        );
      },
    }),
    i(bb, Y, {
    ...
    (db.defaults = {
      ...
      preset: [
        ...
        [$, { enable: !1 }, ['rotate']],
        [bb, { direction: Jb }],
        [Z, { direction: Jb }, ['swipe']],
        [cb],
        [cb, { event: 'doubletap', taps: 2 }, ['tap']],
        [_],
      ],
      cssProps: {
        userSelect: 'none',
    ...
    recognize: function (a) {
      ...
      if (!b.stopped) {
        ...
        for (var f = 0; f < d.length; )
          (c = d[f]),
            b.stopped === oc || (e && c != e && !c.canRecognizeWith(e))
              ? c.reset()
              : c.recognize(a),
            !e && c.state & (hc | ic | jc) && (e = b.curRecognizer = c),
            f++;
      }
    },
    get: function (a) {
