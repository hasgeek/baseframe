...
(function ($) {
  ...
  $.fn.oembed.providers = [
    ...
    new $.fn.oembed.OEmbedProvider(
      ...
      '//www.circuitlab.com/circuit/$1/screenshot/540x405/',
      {
    ...
    new $.fn.oembed.OEmbedProvider(
      ...
      'rich',
      ['linkedin.com/pub/.+'],
      '//www.linkedin.com/cws/member/public_profile?public_profile_url=$1&format=inline&isFramed=true',
      {
        templateRegex: /(.*)/,
    ...
    new $.fn.oembed.OEmbedProvider(
      ...
      'rich',
      ['gist.github.com/.+'],
      '//github.com/api/oembed'
    ),
    new $.fn.oembed.OEmbedProvider(
      'github',
      'rich',
      ['github.com/[-.\\w@]+/[-.\\w@]+'],
      '//api.github.com/repos/$1/$2?callback=?',
      {
        templateRegex: /.*\/([^\/]+)\/([^\/]+).*/,
        templateData: function (data) {
    ...
    new $.fn.oembed.OEmbedProvider(
      ...
      '//graph.facebook.com/$2$3/?callback=?',
      {
