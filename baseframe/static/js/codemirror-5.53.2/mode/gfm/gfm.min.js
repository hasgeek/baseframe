(function (e) {
  ...
  e.defineMode(
    ...
    function (a, o) {
          ...
          token: function (e, a) {
            if (((a.combineTokens = null), a.codeBlock))
              return e.match(/^```+/)
                ? ((a.codeBlock = !1), null)
                : (e.skipToEnd(), null);
            if ((e.sol() && (a.code = !1), e.sol() && e.match(/^```+/)))
              return e.skipToEnd(), (a.codeBlock = !0), null;
            if ('`' === e.peek()) {
              e.next();
              var n = e.pos;
              e.eatWhile('`');
              var r = 1 + e.pos - n;
              return (
                a.code ? r === i && (a.code = !1) : ((i = r), (a.code = !0)),
                null
              );
            }
            if (a.code) return e.next(), null;
            if (e.eatSpace()) return (a.ateSpace = !0), null;
            if (
              (e.sol() || a.ateSpace) &&
              ((a.ateSpace = !1), !1 !== o.gitHubSpice)
            ) {
              if (
                e.match(
      ...
      return (s.name = 'markdown'), e.overlayMode(e.getMode(a, s), r);
    },
    'markdown'
  ),
