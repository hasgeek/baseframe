!(function (e) {
  ...
  T.defineMode('css', function (e, t) {
    ...
    function x(e, t) {
      return (
        e.next(),
        e.match(/\s*[\"\')]/, !1) ? (t.tokenize = null) : (t.tokenize = v(')')),
        w(null, '(')
      );
    }
    function z(e, t, r) {
    ...
    function j(e, t, r, o) {
      return (
        (e.context = new z(r, t.indentation() + (!1 === o ? 0 : a), e.context)),
        r
      );
    }
    function q(e) {
    ...
    var B = {
      top: function (e, t, r) {
        ...
        if ('}' == e && r.context.prev) return q(r);
        if (y && /@component/i.test(e)) return j(r, t, 'atComponentBlock');
        if (/^@(-moz-)?document$/i.test(e)) return j(r, t, 'documentTypes');
        ...
        if (e && '@' == e.charAt(0)) return j(r, t, 'at');
        if ('hash' == e) i = 'builtin';
      ...
      maybeprop: function (e, t, r) {
        return ':' == e ? j(r, t, 'prop') : P(e, t, r);
      },
      prop: function (e, t, r) {
        if (';' == e) return q(r);
        if ('{' == e && f) return j(r, t, 'propBlock');
      ...
      atBlock: function (e, t, r) {
        ...
        if ('}' == e || ';' == e) return K(e, t, r);
        if ('{' == e) return q(r) && j(r, t, f ? 'block' : 'top');
        if ('interpolation' == e) return j(r, t, 'interpolation');
        if ('word' == e) {
          var o = t.current().toLowerCase();
          i =
    ...
    return {
      startState: function (e) {
        return {
          ...
          state: r ? 'block' : 'top',
          stateArg: null,
          context: new z(r ? 'block' : 'top', e || 0, null),
        };
      },
      token: function (e, t) {
        ...
        return (
          r && 'object' == typeof r && ((o = r[1]), (r = r[0])),
          (i = r),
          'comment' != o && (t.state = B[t.state](o, e, t)),
          i
        );
      },
      indent: function (e, t) {
  ...
  var t = ['domain', 'regexp', 'url', 'url-prefix'],
    ...
    k = e(f),
    y = t.concat(o).concat(a).concat(l).concat(d).concat(p).concat(g).concat(f);
  function w(e, t) {
    for (var r, o = !1; null != (r = e.next()); ) {
      if (o && '/' == r) {
        t.tokenize = null;
  ...
  T.registerHelper('hintWords', 'css', y),
