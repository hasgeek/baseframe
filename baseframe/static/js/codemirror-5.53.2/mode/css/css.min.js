(function (e) {
  ...
  e.defineMode('css', function (t, r) {
    ...
    function i(e, t) {
      ...
      return '@' == r
        ? (e.eatWhile(/[\w\\\-]/), o('def', e.current()))
        : '=' == r || (('~' == r || '|' == r) && e.eat('='))
        ? o(null, 'compare')
        : '"' == r || "'" == r
        ? ((t.tokenize = a(r)), t.tokenize(e, t))
        : '#' == r
        ? (e.eatWhile(/[\w\\\-]/), o('atom', 'hash'))
        : '!' == r
        ? (e.match(/^\s*\w*/), o('keyword', 'important'))
        : /\d/.test(r) || ('.' == r && e.eat(/\d/))
        ? (e.eatWhile(/[\w.%]/), o('number', 'unit'))
        : '-' !== r
        ? /[,+>*\/]/.test(r)
          ? o(null, 'select-op')
          ...
          ? (/^(url(-prefix)?|domain|regexp)$/.test(
            ...
            o('variable callee', 'variable'))
          : /[\w\\\-]/.test(r)
          ? (e.eatWhile(/[\w\\\-]/), o('property', 'word'))
          : o(null, null)
        : /[\d.]/.test(e.peek())
        ? (e.eatWhile(/[\w.%]/), o('number', 'unit'))
        : e.match(/^-[\w\\\-]*/)
        ? (e.eatWhile(/[\w\\\-]/),
          e.match(/^\s*:/, !1)
            ? o('variable-2', 'variable-definition')
    ...
    function s(e, t, r, o) {
      return (
        (e.context = new l(r, t.indentation() + (!1 === o ? 0 : h), e.context)),
        r
      );
    }
    function d(e) {
    ...
    var b,
      ...
      y = r.mediaTypes || {},
      w = r.mediaFeatures || {},
      v = r.mediaValueKeywords || {},
      x = r.propertyKeywords || {},
      z = r.nonStandardPropertyKeywords || {},
      j = r.fontProperties || {},
      q = r.counterDescriptors || {},
      P = r.colorKeywords || {},
      K = r.valueKeywords || {},
      C = r.allowNested,
      B = r.lineComment,
      T = !0 === r.supportsAtComponent,
      _ = {
        top: function (e, t, r) {
          if ('{' == e) return s(r, t, 'block');
          if ('}' == e && r.context.prev) return d(r);
          if (T && /@component/i.test(e)) return s(r, t, 'atComponentBlock');
        ...
        block: function (e, t, r) {
          if ('word' == e) {
            ...
            return x.hasOwnProperty(o)
              ? ((g = 'property'), 'maybeprop')
              : z.hasOwnProperty(o)
              ? ((g = 'string-2'), 'maybeprop')
              : C
              ? ((g = t.match(/^\s*:(?:\s|$)/, !1) ? 'property' : 'tag'),
                'block')
              : ((g += ' error'), 'maybeprop');
          }
          return 'meta' == e
            ? 'block'
            : C || ('hash' != e && 'qualifier' != e)
            ? _.top(e, t, r)
            : ((g = 'error'), 'block');
        },
        ...
        pseudo: function (e, t, r) {
          return 'meta' == e
            ? 'pseudo'
            : 'word' == e
            ? ((g = 'variable-3'), r.context.type)
            : c(e, t, r);
        },
        documentTypes: function (e, t, r) {
          return 'word' == e && k.hasOwnProperty(t.current())
            ? ((g = 'tag'), r.context.type)
            : _.atBlock(e, t, r);
        },
        atBlock: function (e, t, r) {
          if ('(' == e) return s(r, t, 'atBlock_parens');
          if ('}' == e || ';' == e) return p(e, t, r);
          if ('{' == e) return d(r) && s(r, t, C ? 'block' : 'top');
          if ('interpolation' == e) return s(r, t, 'interpolation');
          if ('word' == e) {
            var o = t.current().toLowerCase();
            g =
        ...
        atComponentBlock: function (e, t, r) {
          return '}' == e
            ? p(e, t, r)
            : '{' == e
            ? d(r) && s(r, t, C ? 'block' : 'top', !1)
            : ('word' == e && (g = 'error'), r.context.type);
        },
        ...
        restricted_atBlock_before: function (e, t, r) {
          return '{' == e
            ...
            ? ((g = 'variable'), 'restricted_atBlock_before')
            : c(e, t, r);
        },
          ...
          return '}' == e
            ...
            ? ((g =
                ('@font-face' == r.stateArg &&
                  !j.hasOwnProperty(t.current().toLowerCase())) ||
                ('@counter-style' == r.stateArg &&
                  !q.hasOwnProperty(t.current().toLowerCase()))
                  ? 'error'
                  : 'property'),
              'maybeprop')
            : 'restricted_atBlock';
    ...
    return {
      ...
      token: function (e, t) {
        ...
        return (
          r && 'object' == typeof r && ((b = r[1]), (r = r[0])),
          (g = r),
          'comment' != b && (t.state = _[t.state](b, e, t)),
          g
        );
      },
      indent: function (e, t) {
  ...
  var o = ['domain', 'regexp', 'url', 'url-prefix'],
    ...
    x = t(v),
    z = o.concat(a).concat(l).concat(d).concat(p).concat(m).concat(y).concat(v);
