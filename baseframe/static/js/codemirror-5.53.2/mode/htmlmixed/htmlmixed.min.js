!(function (t) {
  ...
  function o(t, e) {
    for (var a in t)
      for (var n = e[a] || (e[a] = []), l = t[a], r = l.length - 1; 0 <= r; r--)
        n.unshift(l[r]);
  }
  f.defineMode(
    'htmlmixed',
    function (u, t) {
      ...
      if ((o(l, d), e && o(e, d), a))
        for (var n = a.length - 1; 0 <= n; n--)
          d.script.unshift(['type', a[n].matches, a[n].mode]);
      function p(t, e) {
        var a,
          n = m.token(t, e.htmlState),
          l = /\btag\b/.test(n);
        if (
          l &&
          !/[<>\s\/]/.test(t.current()) &&
          ...
          e.inTag = a + ' ';
        else if (e.inTag && l && />$/.test(t.current())) {
          var r = /^([\S]+) (.*)/.exec(e.inTag);
          e.inTag = null;
          var o =
              '>' == t.current() &&
              (function (t, e) {
            ...
            return t.match(i, !1)
              ...
              : ((a = t),
                ...
                -1 < (o = r.search(n))
                  ? a.backUp(r.length - o)
                  : r.match(/<\/?$/) &&
                    (a.backUp(r.length), a.match(n, !1) || a.match(r)),
                l);
            var a, n, l, r, o;
          }),
            (e.localMode = c),
            (e.localState = f.startState(c, m.indent(e.htmlState, '', '')));
        } else
        ...
        copyState: function (t) {
          ...
          return (
            t.localState && (e = f.copyState(t.localMode, t.localState)),
            {
              ...
              localState: e,
              htmlState: f.copyState(m, t.htmlState),
            }
          );
        },
        token: function (t, e) {
